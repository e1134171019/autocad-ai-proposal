...
<style>
  ...
  .narrative { margin-top: 14vh; border-top: var(--line-thin) solid var(--border-strong); }
  ...
  h2 { margin: 0; color: var(--foreground); font: 600 1rem/1.5 var(--font-display); }
