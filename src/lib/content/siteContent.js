  ...
  sections: [
    {
      id: '01',
      title: '客戶需求',
      paragraphs: ['完成施工範圍後，希望能直接取得每段長度、整張圖施工總長與指定元件數量。']
    },
    {
      id: '02',
      title: '提案內容',
      paragraphs: ['把驗算與結果查詢放進既有 AutoCAD 作業；施工判斷與繪製仍由繪圖人員負責。']
    },
    {
      id: '03',
      title: '計算條件',
      paragraphs: ['系統先依本次範圍、標準圖層與有效物件建立計算基準，再整理長度與數量。']
    },
    {
      id: '04',
      title: '流程基準',
      paragraphs: ['下一章完整呈現客戶目前的施工圖流程，作為後續方案比較基準。']
    }
  ]
});
...
export const futureFlowSteps = Object.freeze([
  ...
  { id: 7, label: '框選範圍定義本次計算區域', desc: '原生 AutoCAD 的框選主要是一次選取範圍內的物件；在外掛流程中，框選施工範圍同時作為本次計算邊界。系統依照標準圖層辨識施工線、深井與元件，分類後加總長度與數量，再整理結果。', animType: 'box-select-fast', selection: SELECTION_CONTEXT, highlights: [{ text: '框選', tone: 'ai' }, { text: '標準圖層', tone: 'standard' }, { text: '計算邊界', tone: 'standard' }] },
