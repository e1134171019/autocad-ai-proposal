...
export const futureFlowSteps = Object.freeze([
  ...
  { id: 7, label: '框選範圍定義本次計算區域', desc: '原生 AutoCAD 的框選主要是一次選取範圍內的物件；在外掛流程中，框選範圍同時作為本次計算邊界。系統依照標準圖層辨識施工線、深井與元件，分類後加總長度與數量，再整理結果。', animType: 'box-select-fast', selection: SELECTION_CONTEXT, highlights: [{ text: '框選', tone: 'ai' }, { text: '標準圖層', tone: 'standard' }, { text: '計算邊界', tone: 'standard' }] },
