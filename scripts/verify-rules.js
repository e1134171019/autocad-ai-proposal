...
['ACT 06 / PROJECT SUMMARY', '專案效益與預期成果', '實際節省的工時與改善幅度目前沒有量測數據', '經驗規則化', '作業標準化', '知識系統化', '將繪圖人員的工程經驗整理成公司可以保存、團隊可以沿用、程式可以執行的作業規則。'].forEach((phrase) => { if (!summary.includes(phrase)) violations.push(`Act06Summary.svelte: 缺少 ${phrase}`); });
